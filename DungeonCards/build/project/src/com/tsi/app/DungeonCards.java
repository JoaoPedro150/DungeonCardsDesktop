...
public class DungeonCards extends Application {
	...
	public void start(Stage stage) {
		...
		try {
			root = (AnchorPane)FXMLLoader.load(getClass().getResource("/com/tsi/ui/fxml/telaInicial.fxml"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void restart() {
		...
		AnchorPane root = null;
		try {
			root = (AnchorPane)FXMLLoader.load(DungeonCards.class.getResource("/com/tsi/ui/fxml/telaInicial.fxml"));
		} catch (IOException e) {
			e.printStackTrace();
		}
